...
import 'package:lotto/utils/utilities.dart';
...
class FirebaseMethods {
  ...
  Future<void> saveCurrentNumbers(
      Numbers numbers) async {
    var map = numbers.toMap();

    await firestore
        .collection(NUMBERS_COLLECTION)
        .document(numbers.saverId)
        .collection("saved")
        //.collection(Timestamp.now().toDate().toString().split(" ")[0])
        .add(map);
  }
}